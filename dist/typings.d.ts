...
declare const rectangleSeries: SeriesDefinition<"Rectangle">;
 ...
 * ```
 */
export declare function createFVGRectangles<T>(series: ISeriesApi<SeriesType, T>, options?: Partial<FVGRectanglePrimitiveOptions>): IFVGRectangles;
/**
...
export {
	...
	rectangleSeries as RectangleSeries,
};
